...
export function LearningCenter({ open, state, reference, activeLessonId, benchmark, benchmarking, onClose, onLoadLesson, onRunBenchmark, onExportBenchmark }: Props) {
